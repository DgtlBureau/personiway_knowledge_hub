...
export async function GET() {
  const feed = new RSS({
    ...
    feed_url: `https://hub.personiway.com/hvac/expertise/rss.xml`,
  ...
  allExpertise.forEach((expertise) => {
    ...
    feed.item({
      ...
      guid: `https://hub.personiway.com/hvac/expertise/${expertise.slug}`,
      url: `https://hub.personiway.com/hvac/expertise/${expertise.slug}`,
      date: formattedDate,
    })
  })
